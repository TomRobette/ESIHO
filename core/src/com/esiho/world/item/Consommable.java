...
//    private javafx.scene.image.Image image;
    ...
    public Consommable(String id, String nom, Integer valeur, Texture texture, Integer type){
        super(id, nom, valeur, texture);
        this.type=type;
    ...
    public abstract void useItem()//Ce champ sera rempli lorsqu'un Consommable sera initialisé, mais pas lorsqu'il sera utilisé
    ;
